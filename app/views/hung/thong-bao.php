...
<div class="explain">
  <div class="imgbox"> <img src="images/anh-tb.png" class="img_list"><span>Đặt đơn thành công </span> </div>
  <div>
    <ul class="pay_list">
      <li> <span class="tips1">Phương thức thanh toán :</span> <span class="tips2">Nhận hàng thanh toán</span> </li>
        <li> <span class="tips1">Mã đơn hàng:</span> <span class="tips2"> 3611541 </span> </li>
        <?php $t = 30000000;?>
        <!-- <?php $t //= $_GET["n"]; ?> -->
      <li> <span class="tips1">Số tiền thanh toán :</span> <span class="tips2"> <?php echo $t; ?></span> </li>
    </ul>
  </div>
...
<div class="timetips layui-row">
    <ul>
        <li class="layui-col-xs6"><img src="images/30day.png" alt="">Cam kết đổi hàng trong vòng 30 ngày</li>
        <li class="layui-col-xs6"><img src="images/huodao.png" alt="">Nhận tiền mặt khi giao hàng</li>
    </ul>
</div>
